...
<head>
    ...
    <link rel="icon" href="{{ asset('admin-temp/assets/img/icon.ico') }}" type="image/x-icon" />
    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <a href="/" class="logo">
                    <img src="{{ asset('admin-temp/assets/img/logo.svg') }}" alt="navbar brand" class="navbar-brand">
                </a>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li
                            class="nav-item submenu {{ request()->is('pengguna_air', 'tarif_air') ? 'active' : '' }}">
                            <a data-toggle="collapse" href="#base">
                                <i class="fas fa-fill-drip"></i>
                                <p>Air</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse {{ request()->is('pengguna_air', 'tarif_air') ? 'show' : '' }}"
                                id="base">
